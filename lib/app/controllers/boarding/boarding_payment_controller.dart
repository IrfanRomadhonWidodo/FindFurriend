// lib/controllers/boarding/boarding_payment_controller.dart
import 'dart:io';
...
class BoardingPaymentController extends GetxController {
    ...
    try {
      ...
      if (orderId.isNotEmpty && orderId != "null") {
        ...
        if (doc.exists) {
          ...
          // Siapkan data pembayaran untuk boarding
          paymentDetails.value = {
            'orderId': orderId,
            'serviceName':
                "Boarding ${orderData['pet']} - ${orderData['package']}",
