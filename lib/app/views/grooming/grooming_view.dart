...
import '../../controllers/grooming/grooming_controller.dart';

class GroomingView extends StatelessWidget {
  GroomingView({Key? key}) : super(key: key);

  final GroomingController controller = Get.put(GroomingController());
  final pets = ["Kucing", "Anjing"];
  final packages = ["Basic", "Komplit", "Spesial"];
          ...
          children: [
            ...
            ClipRRect(
              ...
              child: CachedNetworkImage(
                imageUrl: 'https://picsum.photos/seed/grooming/400/200.jpg',
                            ...
                            Expanded(
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Text(
                                    controller.packageDetails[controller
                                            .selectedPet
                                            .value]?[pkg] ??
                                        '',
                                    style: TextStyle(
